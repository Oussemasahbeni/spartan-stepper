...
@Component({
  selector: 'docs-stepper-indicators-example',
      ...
      <section class="flex flex-col gap-4 rounded-xl border p-5">
        <header class="space-y-1">
          ...
          <p class="text-sm text-muted-foreground">
            ...
            <code class="font-mono text-foreground">indicatorMode="icon"</code> is enabled.
          </p>
        </header>
...
export class StepperIndicatorsExampleComponent {}
